...
class GoogleMapServices {
  ...
  Future<List> getSuggestions(String query) async {
    ...
    String url =
        '$baseUrl?input=$query&key=$API_KEY&type=$type&language=en&components=country:ng&sessiontoken=$sessionToken';
  ...
  Future<PlaceDetail> getPlaceDetail(String placeId, String token) async {
    ...
    String url =
        '$baseUrl?key=$API_KEY&place_id=$placeId&language=en&sessiontoken=$token';
